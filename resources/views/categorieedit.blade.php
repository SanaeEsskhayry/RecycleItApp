                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    <form class="form" action="{{route('categorie.update',['categorie'=>$cat->idcategorie])}}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first-name-column" class="form-control" value="{{old('categorie',$cat->categorie)}}" placeholder="Categorie" name="categorie">
                                                </div>
                                            </div>
