                                ...
                                <div class="row" style="margin-left: 0.5cm">
                                    <div class="col-sm">
                                        <form action="{{route('users.update',$user->id)}}" method="POST">
                                            ...
                                            <button class="btn btn-primary btn-sm " type="submit">User</i></button>
                                        </form>
                                    </div>
                                    <div class="col-sm">
                                        <form action="{{route('users.update',$user->id)}}" method="POST">
                                    ...
                                    <div class="col-sm">
                                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#staticBackdrop{{$user->id}}">
