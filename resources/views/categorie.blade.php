                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Listes Des Categories</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first-name-column" class="form-control"
                                                        placeholder="Categorie" name="categorie">
                                                </div>
                                            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row" style="margin-left: 0.5cm">
                                    <div class="col-sm">
                                        <a class="btn btn-primary btn-sm" href="{{route('categorie.edit',['categorie'=> $cat->idcategorie])}}">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                
                                    </div>
                                    <div class="col-sm">
                                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#staticBackdrop{{$cat->idcategorie}}">
                                            <i class="fa fa-trash"> Delete</i>
                                          </button>
                                          
                                          <!-- Modal -->
                                          <div class="modal fade" id="staticBackdrop{{$cat->idcategorie}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body" style="text-align: center">
                                                    voulez vous Supprimer categorie
                                                    <br>   <strong>{{$cat->categorie}}  ?? </strong>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Annuler</button>
                                                    <form action="{{ route('categorie.destroy',['categorie'=> $cat->idcategorie])}}" method="POST">
                                                      @csrf
                                                      @method('DELETE')
