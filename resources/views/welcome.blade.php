            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <a href="login" ><strong>Se connecter </strong></a>
                        <a href="register" ><strong>S'inscrire </strong></a>    
                        </div><!-- end search -->
                    </div><!-- end col -->
                </div><!-- end row -->
            </div><!-- end header-logo -->
        ...
        <div class="header-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo">
                            <a href="welcome"><img src="images/logo.jpeg" alt=""></a>
                        </div><!-- end logo -->
                    </div>
                </div><!-- end row -->
            </div><!-- end header-logo -->
                ...
                <nav class="navbar navbar-inverse navbar-toggleable-md">
                    ...
                    <div class="collapse navbar-collapse justify-content-md-center" id="Forest Timemenu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link color-green-hover" href="garden-category.html">Catégories</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link color-green-hover" href="garden-category.html">Bons Gestes</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link color-green-hover" href="garden-category.html">Challenges</a>
                            </li> 
                            <li class="nav-item">
                ...
                <div class="row">
                            ...
                            <div class="blog-list clearfix">
                                <div class="blog-box row">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <span class="bg-aqua"><a href="garden-category.html" title="">categorie</a></span>
                                        <h4><a href="showproduit" title="">The best twenty plant species you can look at at home</a></h4>
                                        <small><a  title=""><i class="fa fa-eye"></i> 1887</a></small>
                                        <small><a title="">11 July, 2017</a></small>
                                        <small><a  title="">by Matilda</a></small>
                                    </div><!-- end meta -->
                                </div><!-- end blog-box -->
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                        <div class="sidebar">
                            ...
                            <div class="widget">
                                <h2 class="widget-title">challenge de la semaine</h2>
